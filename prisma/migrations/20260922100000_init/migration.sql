...
-- CreateEnum
CREATE TYPE "SwapStatus" AS ENUM ('PENDING', 'OFFERED', 'ACCEPTED', 'APPROVED', 'REJECTED');
...
CREATE TABLE "Organization" (
    ...
    "overtimeHoursPerWeek" DOUBLE PRECISION NOT NULL DEFAULT 40,
    "requireLocationClockIn" BOOLEAN NOT NULL DEFAULT false,
...
-- CreateIndex
CREATE INDEX "Shift_organizationId_start_end_idx" ON "Shift"("organizationId", "start", "end");

-- CreateIndex
CREATE INDEX "Shift_assigneeId_start_end_idx" ON "Shift"("assigneeId", "start", "end");
...
-- AddForeignKey
ALTER TABLE "SwapRequest" ADD CONSTRAINT "SwapRequest_fromUserId_fkey" FOREIGN KEY ("fromUserId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
